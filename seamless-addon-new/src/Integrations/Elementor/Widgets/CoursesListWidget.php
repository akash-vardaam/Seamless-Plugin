    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'yes',
                'description' => __('Show or hide the course search and filter bar.', 'seamless-addon'),
            ]
        );
...
?>
    ...
    protected function render_preview($settings)
    {
        ...
        $show_search_bar = $this->is_search_bar_enabled($settings);
        $preview_courses = $this->get_preview_courses();

        $this->render_widget_styles($columns);

        echo '<div class="seamless-courses-list-preview seamless-courses-list-shell seamless-event-wrapper-without-dropdown">';
                ...
                <div class="seamless-nd-searchbar-wrap">
                    <div class="seamless-nd-row">
                        <div class="seamless-nd-search-field">
                            ...
                            <input type="text" class="seamless-nd-search-input" placeholder="<?php esc_attr_e('Search courses...', 'seamless-addon'); ?>" aria-label="<?php esc_attr_e('Search courses', 'seamless-addon'); ?>" readonly />
                        </div>

                        <div class="seamless-nd-controls">
                            <div class="seamless-nd-dropdown-wrap">
                                <button type="button" class="seamless-nd-btn seamless-nd-course-type-btn" aria-expanded="false">
                                    <span class="seamless-nd-course-type-label"><?php esc_html_e('All Courses', 'seamless-addon'); ?></span>
                            ...
                            <div class="seamless-nd-dropdown-wrap">
                                <button type="button" class="seamless-nd-btn seamless-nd-year-btn" aria-expanded="false">
                            ...
                            <div class="seamless-nd-dropdown-wrap">
                                <button type="button" class="seamless-nd-btn seamless-nd-sort-btn seamless-nd-active-filter" aria-expanded="false">
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                                        <line x1="12" y1="5" x2="12" y2="19"></line>
                                        <polyline points="5 12 12 5 19 12"></polyline>
                                    </svg>
                                    <span class="seamless-nd-sort-label"><?php esc_html_e('Newest First', 'seamless-addon'); ?></span>
                                    <svg class="seamless-nd-chevron" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                                        <polyline points="6 9 12 15 18 9"></polyline>
                                    </svg>
                                </button>
                            ...
                            <button type="button" class="seamless-nd-btn seamless-nd-reset-btn" aria-label="<?php esc_attr_e('Reset all course filters', 'seamless-addon'); ?>">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
        ...
        echo '<div class="seamless-courses-grid" style="grid-template-columns: repeat(' . esc_attr($columns) . ', 1fr);">';
        foreach ($preview_courses as $course) {
            $this->render_preview_course_card($course);
        }
        echo '</div>';
        echo '</div>';
    }
    ...
    private function get_preview_courses()
    {
        return [
            [
                'title' => __('Leadership Essentials', 'seamless-addon'),
                'description' => __('A practical course preview for building leadership, communication, and strategic planning skills.', 'seamless-addon'),
                'access_label' => __('Free', 'seamless-addon'),
                'access_value' => 'free',
                'price' => __('Free', 'seamless-addon'),
                'published_at' => '2026-02-12',
                'duration' => __('2 Hours', 'seamless-addon'),
                'lessons' => 8,
            ],
            [
                'title' => __('Advanced Compliance Workshop', 'seamless-addon'),
                'description' => __('Preview how paid courses appear with metadata, pricing, and the updated toolbar controls.', 'seamless-addon'),
                'access_label' => __('Paid', 'seamless-addon'),
                'access_value' => 'paid',
                'price' => '$149.00',
                'published_at' => '2025-08-03',
                'duration' => __('3 Hours', 'seamless-addon'),
                'lessons' => 12,
            ],
            [
                'title' => __('Member Onboarding Foundations', 'seamless-addon'),
                'description' => __('A sample course card used inside the Elementor editor preview so the layout is visible before publishing.', 'seamless-addon'),
                'access_label' => __('Free', 'seamless-addon'),
                'access_value' => 'free',
                'price' => __('Free', 'seamless-addon'),
                'published_at' => '2024-11-18',
                'duration' => __('Self-paced', 'seamless-addon'),
                'lessons' => 6,
            ],
        ];
    }
    ...
    {
        $title = $course['title'] ?? __('Untitled Course', 'seamless-addon');
        $description = $course['description'] ?? '';
        $access_label = $course['access_label'] ?? __('Free', 'seamless-addon');
        $access_value = $course['access_value'] ?? 'free';
        $badge_class = $access_value === 'paid' ? 'seamless-badge-paid' : 'seamless-badge-free';
        $price = $course['price'] ?? __('Free', 'seamless-addon');
        $duration = $course['duration'] ?? __('Self-paced', 'seamless-addon');
                ...
                <div class="seamless-course-meta-row">
                    ...
                    <?php if ($lessons > 0) : ?>
                        <div class="seamless-course-meta">
                            ...
                            <span><?php echo esc_html(sprintf(_n('%d Lesson', '%d Lessons', $lessons, 'seamless-addon'), $lessons)); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="seamless-course-footer">
                    <div class="seamless-course-price"><?php echo esc_html($price); ?></div>
                    <a href="#" class="seamless-course-button"><?php esc_html_e('View Details', 'seamless-addon'); ?></a>
                </div>
            </div>
        </div>
<?php
    ...
    protected function render()
    {
        ...
        $columns = isset($settings['columns']) ? $settings['columns'] : '3';
        $show_search_bar_value = $show_search_bar ? 'true' : 'false';
        echo '<div class="seamless-courses-list-wrapper seamless-courses-list-shell seamless-event-wrapper-without-dropdown" data-columns="' . esc_attr($columns) . '" data-show-search-bar="' . esc_attr($show_search_bar_value) . '">';
