...
<div class="seamless-user-dashboard" data-widget-id="<?php echo esc_attr($widget_id); ?>">
  <aside class="seamless-user-dashboard-sidebar">
    ...
    <nav class="seamless-user-dashboard-nav">
      ...
      <a href="<?php echo esc_url('/logout'); ?>" class="seamless-user-dashboard-nav-item seamless-user-dashboard-nav-logout">
...
<script type="text/javascript">
  var seamlessUserDashboard = {
    ...
    requestGroupRemovalNonce: '<?php echo wp_create_nonce('seamless_request_group_removal'); ?>',
