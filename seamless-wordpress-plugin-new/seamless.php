...
function seamless_activate()
{
    ...
    if (!get_option('seamless_product_list_endpoint')) {
        add_option('seamless_product_list_endpoint', 'shop');
    }
    if (!get_option('seamless_single_product_endpoint')) {
        add_option('seamless_single_product_endpoint', 'product');
    }
    if (!get_option('seamless_shop_cart_endpoint')) {
        add_option('seamless_shop_cart_endpoint', 'shops/cart');
    }
