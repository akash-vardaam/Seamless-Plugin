...
class MembershipName extends Tag
{
    ...
    {
        return 'seamless-membership-name';
    }

    public function get_title()
    {
        return __('Membership Name', 'seamless-addon');
    }
    ...
    public function render()
    {
        ...
        } elseif ($membership && isset($membership['title'])) {
            echo esc_html($membership['title']);
        }
    }
