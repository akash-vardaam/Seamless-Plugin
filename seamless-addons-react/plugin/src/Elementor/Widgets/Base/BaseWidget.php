...
namespace SeamlessReact\Elementor\Widgets\Base;
...
abstract class BaseWidget extends \Elementor\Widget_Base
{
    ...
    protected function add_common_style_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Content Typography', 'seamless-react'),
        ...
        $this->add_control(
            'content_color',
            [
                'label' => __('Content Color', 'seamless-react'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
    ...
    protected function add_event_selection_controls()
    {
        $this->add_control(
            ...
            [
                ...
                'raw' => '<div>' .
                    __('Automatically detects event data from URL on single event pages.', 'seamless-react') .
                    '</div>',
    ...
    protected function add_html_tag_control($name = 'html_tag', $default = 'h2')
    {
        $this->add_control(
            $name,
            [
                'label' => __('HTML Tag', 'seamless-react'),
    ...
    protected function get_preview_event_data()
    {
        return [
            ...
            'featured_image' => SEAMLESS_REACT_URL . 'assets/images/placeholder-image.png',
            'image_url' => SEAMLESS_REACT_URL . 'assets/images/placeholder-image.png',
    ...
    protected function  add_accordion_style_controls()
    {
        ...
        $this->add_control(
            ...
            [
                'label' => __('Accordion Header', 'seamless-react'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Accordion Icon', 'seamless-react'),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Icon Spacing', 'seamless-react'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Icon Rotation (Active)', 'seamless-react'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['deg'],
                'range' => [
                    'deg' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Accordion Body', 'seamless-react'),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Accordion Item', 'seamless-react'),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
