...
<div class="seamless-user-dashboard-summary-grid">
    ...
    <?php if ($current_membership):
        ...
        $card_class = 'seamless-user-dashboard-current-membership-card';
                        ...
                        ?>
                            <div class="seamless-user-dashboard-membership-card" data-membership-index="<?php echo esc_attr($index); ?>">
                                <div class="seamless-user-dashboard-membership-content">
                                    <div class="seamless-user-dashboard-membership-title-row">
                                    ...
                                    <div class="seamless-user-dashboard-membership-actions">
                                        ...
                                        $is_group = !empty($m['plan']['is_group_membership']) && ($m['plan']['is_group_membership'] == 1 || $m['plan']['is_group_membership'] === true);
                                        $group_role = strtolower((string)($m['group_role'] ?? ($m['role'] ?? '')));
                                        $is_group_owner = $is_group && (!empty($m['is_owner']) || $group_role === 'owner');
                                        $can_request_group_removal = $is_group && $is_active && !$is_group_owner && in_array($group_role, ['admin', 'member'], true);
                                        $has_requested_group_removal = !empty($m['has_requested_removal']);
                                        $show_owner_membership_actions = !$is_group || $is_group_owner;
                                        $show_membership_menu = !$is_cancelled && (
                                            ($show_owner_membership_actions && ($has_upgrades || $has_downgrades || $is_active)) ||
                                            $can_request_group_removal
                                        );
                                        ...
                                        if ($show_membership_menu): ?>
                                            <div class="seamless-user-dashboard-menu-container">
                                                ...
                                                <div class="seamless-user-dashboard-menu-dropdown">
                                                    <?php if ($show_owner_membership_actions && $has_upgrades): ?>
                                                    ...
                                                    <?php if ($show_owner_membership_actions && $has_downgrades): ?>
                                                    ...
                                                    <?php if ($show_owner_membership_actions && $is_active): ?>
                                                    ...
                                                    <?php if ($can_request_group_removal): ?>
                                                        <button class="seamless-user-dashboard-menu-item seamless-user-dashboard-group-request-removal"
                                                            data-membership-id="<?php echo esc_attr($m['id']); ?>"
                                                            data-plan-label="<?php echo esc_attr($label); ?>"
                                                            data-membership-data="<?php echo esc_attr(json_encode($m)); ?>"
                                                            data-has-requested-removal="<?php echo esc_attr($has_requested_group_removal ? '1' : '0'); ?>"
                                                            <?php disabled($has_requested_group_removal); ?>
                                                            aria-disabled="<?php echo esc_attr($has_requested_group_removal ? 'true' : 'false'); ?>"
                                                            title="<?php echo esc_attr($has_requested_group_removal ? __('Removal request already sent', 'seamless-addon') : __('Request removal from this group membership', 'seamless-addon')); ?>">
                                                            ...
                                                            <?php echo $has_requested_group_removal ? esc_html__('Removal Requested', 'seamless-addon') : esc_html__('Request Removal', 'seamless-addon'); ?>
                                                        </button>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        ...
                                        <?php if ($is_group): ?>
                                            <span class="seamless-user-dashboard-badge-group" title="<?php esc_attr_e('Group Membership', 'seamless-addon'); ?>">
...
<!-- Request Group Removal Modal -->
<div class="seamless-user-dashboard-cancel-modal" id="seamless-request-removal-modal" style="display: none;">
    <div class="seamless-user-dashboard-modal-overlay"></div>
    <div class="seamless-user-dashboard-modal-container">
        <div class="seamless-user-dashboard-modal-header">
            <h3><?php _e('Request Removal From Group', 'seamless-addon'); ?></h3>
        </div>

        <div class="seamless-user-dashboard-modal-body">
            <div class="seamless-user-dashboard-modal-content">
                <div class="seamless-user-dashboard-remove-modal-warning">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <circle cx="12" cy="12" r="10"></circle>
                        <line x1="12" y1="8" x2="12" y2="12"></line>
                        <line x1="12" y1="16" x2="12.01" y2="16"></line>
                    </svg>
                    <p><?php _e('Are you sure you want to request removal from this group membership?', 'seamless-addon'); ?></p>
                    <p class="seamless-user-dashboard-request-removal-note"><?php _e('This will notify the group owner so they can review your request.', 'seamless-addon'); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="seamless-user-dashboard-modal-footer">
            <div class="seamless-user-dashboard-modal-actions">
                <button class="seamless-user-dashboard-btn seamless-user-dashboard-btn-secondary seamless-user-dashboard-modal-keep-request-removal">
                    <?php _e('No', 'seamless-addon'); ?>
                </button>
                <button class="seamless-user-dashboard-btn seamless-user-dashboard-btn-danger seamless-user-dashboard-modal-confirm-request-removal">
                    <span class="seamless-user-dashboard-modal-confirm-request-removal-text"><?php _e('Yes', 'seamless-addon'); ?></span>
                </button>
            </div>
        </div>
    </div>
